        ...
        <div className="container-small content-spacer">
            <Row>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Omniasig} alt={"logo Omniasig"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Asirom} alt={"logo Asirom"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Porsche} alt={"logo Porsche"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Generali} alt={"logo Generali"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Groupama} alt={"logo Groupama"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Grawe} alt={"logo Grawe"} />
                </Col>

                <Col xs={12} sm={6} md={6} lg={6} xl={6} className={className}>
                    <Image src={Gothaer} alt={"logo Gothaer"} />
                </Col>
                <Col xs={12} sm={6} md={6} lg={6} xl={6} className={className}>
                    <Image src={Garanta} alt={"logo Garanta"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Apan} alt={"logo Apan"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={AutomotiveBavaria} alt={"logo AutomotiveBavaria"} />
                </Col>
                <Col xs={12} sm={6} md={4} lg={4} xl={4} className={className}>
                    <Image src={Autonom} alt={"logo Autonom"} />
                </Col>
            </Row>
        </div>
    )
